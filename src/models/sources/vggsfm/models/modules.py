...
# Attempt to import FlashAttention from xFormers
try:
    import xformers.ops
    FLASH_ATTENTION_AVAILABLE = True
    print("xFormers is available. Using it!")
except ImportError:
    FLASH_ATTENTION_AVAILABLE = False
    print("xFormers not available. Falling back to nn.MultiheadAttention.")
...
class AttnBlock(nn.Module):
    def __init__(
        ...
        **block_kwargs
        ...
        self.mlp = Mlp(
            in_features=hidden_size, hidden_features=mlp_hidden_dim, drop=0.1
        )
