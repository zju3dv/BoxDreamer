...
LastEditTime: 2025-03-17 14:52:33
Description: This module provides a dataset class for the LINEMOD-BoxDreamer dataset,
which is preprocessed by OnePose++. It is designed to be compatible with
...
class LINEMOD_BoxDreamer(BoxDreamerBaseDataset):
    """LINEMOD-BoxDreamer Dataset Class.
    ...
    def __init__(self, config: DictConfig, split: str):
        ...
        self.test_root = os.path.join(self.root, "real_test")
        ...
        self.default_intrinsics = [572.4114, 573.57043, 325.2611, 242.04899]
    ...
    def load_data(self):
        ...
        self.images["ref"] = self.images["train"]
        self.boxes["ref"] = self.boxes["train"]
        self.poses["ref"] = self.poses["train"]
        self.intrinsics["ref"] = self.intrinsics["train"]
        self.cat_len["ref"] = self.cat_len["train"]
    ...
    def _load_data_from_dir(self, root: str, split: str, max_workers: int = 8):
        ...
        def process_category(cat):
            ...
            bbox_pattern = "-box.txt" if split == "train" else "-box_fasterrcnn.txt"
